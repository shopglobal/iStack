...
interface ISTAKEPOOL {
    ...
    // function Vaults() external returns (address payable[] memory);
    // function Vault(uint _i) external returns (address payable);
    // function deploy_iVault(uint pool_id) external returns(address payable);
